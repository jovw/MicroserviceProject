...
class App(ctk.CTk):
        def __init__(self):
                ...
                self.sidebar_frame = ctk.CTkFrame(self, width=140, corner_radius=0, fg_color="#3f3f3f")
                self.sidebar_frame.grid(row=0, column=0, rowspan=4, sticky="nsew")
                self.sidebar_frame.grid_rowconfigure(4, weight=1)
                # Main Title
                self.logo_label = ctk.CTkLabel(self.sidebar_frame, text="Weather App", font=ctk.CTkFont(size=20, weight="bold"), )
